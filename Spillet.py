...
print(f""">Hei, {spiller['Navn']}!
        ...
        >Du og din bestemor har planlagt en harrytur i lang tid å.
    ...
    multiEvents(
        ...
        [
            ...
            [
                ...
                ">Du vet ikke hvordan, men du klarer å løpe fra bjørnen! \n>Den feite bjørnen slitter å jage deg etterhvert, og når du er helt sikker på at den ikke følger etter deg, fortsetter du å gå nedover stien",
